...
// session_start();
if(isset($_SESSION["friend_username"])) {
    $username_1 = $_SESSION["friend_username"];
} else {
    echo "<script>window.open('../sign_up_folder/sign_in.php', '_self')</script>";
}

if(isset($_SESSION["friend_unique_id"])) {
    $user_unique_id_1 = $_SESSION["friend_unique_id"];
} else {
...
<head>
    ...
    <!-- ends here -->
    <!-- link css start here -->
    <link rel="stylesheet" href="./friend_profile_control/friend_about.css">
    <script defer src="./friend_profile_control/friend_about.js"></script>
        ...
        <div class="div-about-1">
            ...
            <div class="div-about-4 hiddens">
                <div class="about-div">
                    ...
                    <h4  class="div-about-h4-2"><?php if($user_work == "&plus; Add a WorkPlace") {echo "No Details"; } else { echo $user_work; } ?></h4>
                </div>
            </div>
            <!-- div 5 -->
            <div class="div-about-5 hiddens">
                <div class="about-div">
                    ...
                    <h4 class="about-h4-3"><?php if($user_place_lived == "&plus; Visited Places") {echo "No Details"; } else { echo $user_place_lived; } ?></h4>
                </div>
            </div>
            <!-- div 6 -->
            <div class="div-about-6 hiddens">
                <div class="about-div">
                    ...
                    <h4 class="about-h4-4"><?php if($user_relationship == "&plus; Relationship Status") {echo "No Details"; } else { echo $user_relationship; } ?></h4>
                </div>
            </div>
            <!-- div 7 -->
            <div class="div-about-7 hiddens">
                <div class="about-div">
                    ...
                    <h4 class="about-h4-5"><?php if($user_home_town == "&plus; Home Town") {echo "No Details"; } else { echo $user_home_town; } ?></h4>
                </div>
            </div>
            <!-- div 8 -->
            <div class="div-about-8 hiddens">
                <div class="about-div">
                    ...
                    <h4 class="about-h4-6"><?php if($user_details == "&plus; Something people need to know!!") {echo "No Details"; } else { echo $user_details; } ?></h4>
                </div>
            </div>
            <!-- div 9 -->
        </div>
