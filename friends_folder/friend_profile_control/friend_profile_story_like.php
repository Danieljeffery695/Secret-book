...
<body>
    ...
    if(isset($_POST["user_profile_like"])) {
        ...
        if($result) {
            ...
            $notification_friend_unique_id = $row_data["user_unique_id"];
            $notification_friend_username = $row_data["username"];
            ...
            $un_clicked = "false";
            if($row_count >= 1) {
                $select_post_1 = "select * from `profile_story_like` where post_id = $story_id and user_unique_id = $user_unique_id";
                ...
                if($like_row >= 1) {
                      ...
                      if($btn_liked == "true") {
                        ...
                        $select_post_2 = "select * from `profile_story_like` where post_id = $story_id and is_clicked = 'true'";
                        ...
                        $update_post_like = "update `profile_story` set user_story_like = $row_like_count where story_id = $story_id";
                        ...
                        $select_post_3 = "select * from `profile_story_like` where post_id = $story_id and is_clicked = 'true'";
                        ...
                        $update_post_like_1 = "update `profile_story` set user_story_like = $row_like_count_1 where story_id = $story_id";
                    ...
                    $insert_notification_stmt->bind_param("isisssi", $user_unique_id, $username, $notification_friend_unique_id, $notification_friend_username, $post_comment, $post_unseen, $user_post_like);
                    $insert_notification_stmt->execute();
    

                    $select_post_4 = "select * from `profile_story_like` where post_id = $story_id and is_clicked = 'true'";
                    ...
                    $update_post_like_3 = "update `profile_story` set user_story_like = '$row_like_count_2' where story_id = $story_id";
