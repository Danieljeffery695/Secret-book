...
if(isset($_SESSION["user_unique_id"])) {
  $user_unique_id_2 = $_SESSION["user_unique_id"];
} else {
...
<head>
    ...
    <title>Photos</title>
    <link rel="stylesheet" href="user_photo.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" />
    <script defer src="user_photo.js"></script>
</head>
<body>
...
<div class="photo-container">
    ...
    <div class="swiper mySwiper first-photo-div">
        <div class="swiper-wrapper">
          ...
          while($photo_row = mysqli_fetch_assoc($photo_result))  {
            ...
            echo "
            <div class='swiper-slide'><img src='./user_post_img/$user_photo_img' class='photo-img' alt='Uploaded Images'></div>";  
            $photo_count++;
    ...
    while($photo_more = mysqli_fetch_assoc($photo_result)) {
      ...
      echo "
      <div class='more-photo-div-1'><img src='./user_post_img/$user_photo_more' alt='more photos' class='photo-img-1'></div>
      ";
    };
      ?>
