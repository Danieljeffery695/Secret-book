...
<html lang="en">
  ...
  <body>
    ...
    if(isset($_POST["home_story_comment"])) {
      $story_comment_id = $_POST["home_story_comment_id"];
      $story_comment = $_POST["home_story_comment"];
      $story_post = $_POST["home_comment_story"];

      $select_comment_1 = "select * from `user_home_story` where story_unique_id = $story_comment and user_unique_id = $story_comment_id and user_color = '$story_post'";
